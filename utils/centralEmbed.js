    ...
    async createCentralEmbed(channelId, guildId) {
        try {
            ...
            .setAuthor({ name: 'Ultimate Music Control Center', iconURL: 'https://cdn.discordapp.com/emojis/896724352949706762.gif', url: 'https://discord.gg/xQF9f9yUEM' })
                ...
                .addFields(
                    {
                        name: '<a:example:1420038058794942535> Quick Examples',
                        value: [
                            '• `shape of you`',
                            '• `lofi hip hop beats`',
                    ...
                    {
                        name: '<a:feature:1420038079523196938> Features',
                        value: [
                            '• <a:musical_note:1420038128000831498> High quality audio',
                            '• <a:library:1420038090579247184> Queue management', 
                            '• <a:loop:1420038115061665843> Loop & shuffle modes',
                            '• <a:volume_adjust:1420038262592114800> Volume controls',
                            '• <a:fast:1420038069918240818> Lightning fast search'
                        ].join('\n'),
                        inline: true
                    },
                    {
                        name: '<a:tips:1420038234830012426> Pro Tips',
                        value: [
        ...
        try {
            ...
            if (trackInfo) {
                ...
                embed = new EmbedBuilder()
                    ...
                    .setDescription([
                        `**<:artist:1420037892021026896> Artist:** ${trackInfo.author}`,
                        `**<:user:1420038246058164317> Requested by:** <@${trackInfo.requester.id}>`,
                        '',
                        `<a:duration:1420038046572609578> **Duration:** \`${this.formatDuration(trackInfo.duration)}\``,
                        `${loopEmoji} **Loop:** \`${trackInfo.loop || 'Off'}\``,
                        `<a:audio:1420038003312689224> **Volume:** \`${trackInfo.volume || 50}%\``,
                        '',
                        '<a:musical_note:1420038128000831498> *Enjoying the vibes? Type more song names below to keep the party going!*'
                    ].join('\n'))
                    .setColor(embedColor)
