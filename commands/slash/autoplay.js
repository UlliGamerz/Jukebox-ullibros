...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            if (!canUse) {
                const embed = new EmbedBuilder().setDescription('<a:cross:1420038015123722250> You need DJ permissions to change autoplay settings!');
            ...
            const embed = new EmbedBuilder().setDescription('<a:cross:1420038015123722250> An error occurred while toggling autoplay!');
            return interaction.editReply({ embeds: [embed] })
                .then(() => setTimeout(() => interaction.deleteReply().catch(() => {}), 3000));
        }
    }
