        ...
        try {
            ...
            if (serverConfig?.centralSetup?.enabled) {
                return interaction.editReply({
                    content: '<a:cross:1420038015123722250> Central music system is already setup! Use `/disable-central` first to reset.',
                    ephemeral: true
                });
            }
            ...
            if (!channel.permissionsFor(botMember).has(['SendMessages', 'EmbedLinks', 'ManageMessages'])) {
                return interaction.editReply({
                    content: '<a:cross:1420038015123722250> I need `Send Messages`, `Embed Links`, and `Manage Messages` permissions in this channel!',
                    ephemeral: true
                });
            }
            ...
            if (!embedMessage) {
                return interaction.editReply({
                    content: '<a:cross:1420038015123722250> Failed to create central embed!',
                    ephemeral: true
                });
            }
            ...
            const successEmbed = new EmbedBuilder()
                .setTitle('<a:tick:1420038198989684736> Central Music System Setup Complete!')
                ...
                try {
                    const usageEmbed = new EmbedBuilder()
                        ...
                        .setDescription(
                            ...
                            '<a:warn:1420038272800784424> This message will be automatically deleted in 10 seconds!'
                        )
                        .setColor(0x1DB954)
            ...
            await interaction.editReply({
                content: '<a:cross:1420038015123722250> An error occurred while setting up the central music system!',
                ephemeral: true
            });
        }
    }
