        ...
        if (interaction.isChatInputCommand()) {
            ...
            if (!shiva || !shiva.validateCore || !shiva.validateCore()) {
                const embed = new EmbedBuilder()
                    .setDescription('<a:cross:1420038015123722250> System core offline - Commands unavailable')
                    .setColor('#FF0000');
            ...
            if (!command.securityToken || command.securityToken !== shiva.SECURITY_TOKEN) {
                ...
                const securityEmbed = new EmbedBuilder()
                    .setDescription('<a:cross:1420038015123722250> Command blocked - Security validation required')
                    .setColor('#FF6600');
            ...
            try {
                ...
                if (!interaction.shivaValidated || !interaction.securityToken || interaction.securityToken !== shiva.SECURITY_TOKEN) {
                    ...
                    const warningEmbed = new EmbedBuilder()
                        .setDescription('<a:warn:1420038272800784424> Security anomaly detected - Command execution logged')
                        .setColor('#FF6600');
                ...
                if (error.message.includes('shiva') || error.message.includes('validateCore')) {
                    const securityEmbed = new EmbedBuilder()
                        .setDescription('<a:cross:1420038015123722250> System security modules offline - Commands unavailable')
                        .setColor('#FF0000');
...
async function handleSecureMusicButton(interaction, client) {
    ...
    try {
        ...
        if (!conditions.hasActivePlayer) {
            return interaction.reply({
                content: '<a:cross:1420038015123722250> No music is currently playing!',
                ephemeral: true
            });
        }
        ...
        if (!conditions.userInVoice) {
            return interaction.reply({
                content: '<a:cross:1420038015123722250> You need to be in a voice channel to control music!',
                ephemeral: true
            });
        }
        ...
        if (!conditions.sameVoiceChannel) {
            ...
            return interaction.reply({
                content: `<a:cross:1420038015123722250> You need to be in **${botChannelName}** voice channel to control music!`,
                ephemeral: true
            });
        }
        ...
        if (!canUseMusic) {
            return interaction.reply({
                content: '<a:cross:1420038015123722250> You need DJ permissions to control music!',
                ephemeral: true
            });
        }
        ...
        switch (action) {
            case 'pause':
                ...
                await interaction.reply({
                    content: '<:pause:1420038150377705584> Music paused',
                    ephemeral: true
                });
            ...
            case 'resume':
                player.pause(false);
                await interaction.reply({
                    content: '<:play:1420038160347430952> Music resumed',
                    ephemeral: true
                });
                await updateCentralEmbed();
                break;
            ...
            case 'skip':
                ...
                player.stop();
                await interaction.reply({
                    content: `<a:skip:1420038188533284864> Skipped: \`${currentTrack}\``,
                    ephemeral: true
                });
                break;
            ...
            case 'stop':
                player.destroy();
                await interaction.reply({
                    content: '<a:stop:1420040669333946418> Music stopped and disconnected',
                    ephemeral: true
                });
                break;
            ...
            case 'volume_up':
                ...
                await interaction.reply({
                    content: `<a:audio:1420038003312689224> Volume increased to ${newVolumeUp}%`,
                    ephemeral: true
                });
                await updateCentralEmbed();
                break;
            ...
            case 'volume_down':
                ...
                await interaction.reply({
                    content: `<a:audio:1420038003312689224> Volume decreased to ${newVolumeDown}%`,
                    ephemeral: true
                });
                await updateCentralEmbed();
                break;
            ...
            case 'queue':
                if (player.queue.size === 0) {
                    return interaction.reply({
                        content: '<a:library:1420038090579247184> Queue is empty',
                        ephemeral: true
                    });
                }
                ...
                await interaction.reply({
                    content: `<a:library:1420038090579247184> **Queue (${player.queue.size} songs)**\n${queueList}${moreText}`,
                    ephemeral: true
                });
                break;
            ...
            case 'shuffle':
                if (player.queue.size === 0) {
                    return interaction.reply({
                        content: '<a:cross:1420038015123722250> Queue is empty, nothing to shuffle!',
                        ephemeral: true
                    });
                }
            ...
            default:
                await interaction.reply({
                    content: '<a:cross:1420038015123722250> Unknown button action',
                    ephemeral: true
                });
        }
        ...
        await interaction.reply({
            content: '<a:cross:1420038015123722250> An error occurred while processing your request',
            ephemeral: true
        }).catch(() => {});
    }
}
