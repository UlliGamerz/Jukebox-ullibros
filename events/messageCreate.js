        ...
        try {
            ...
            if (!shiva || !shiva.validateCore || !shiva.validateCore()) {
                ...
                const embed = new EmbedBuilder()
                    .setDescription('<a:cross:1420038015123722250> System core offline - Bot unavailable')
                    .setColor('#FF0000');
...
async function validateCentralVoiceAccess(message, client, serverConfig) {
    ...
    if (!userVoiceChannelId) {
        return { valid: false, reason: '<a:cross:1420038015123722250> You must be in a voice channel to request songs!' };
    }
    ...
    if (configuredVoiceChannelId && userVoiceChannelId !== configuredVoiceChannelId) {
        ...
        return { valid: false, reason: `<a:cross:1420038015123722250> You must be in **${channelName}** voice channel to use central music system!` };
    }
    ...
    if (botVoiceChannelId && botVoiceChannelId !== userVoiceChannelId) {
        ...
        if (configuredVoiceChannelId && userVoiceChannelId === configuredVoiceChannelId) {
            ...
            return { valid: false, reason: `<a:cross:1420038015123722250> Bot is already playing in **${botVoiceChannel?.name}**! Join that channel or wait for music to end.` };
        }
    }
